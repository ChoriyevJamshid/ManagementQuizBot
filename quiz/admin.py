...
@admin.register(models.ScheduledSession)
class ScheduledSessionAdmin(ModelAdmin):
    compressed_fields = True
    warn_unsaved_form = True
    list_filter_submit = True

    list_display = (
        "id", "group_title", "group_id", "parts_display",
    ...
    fieldsets = (
        ("Main", {
            "classes": ("tab",),
            "fields": ("created_by", "group_id", "group_title", "status"),
        }),
        ("Schedule", {
            "classes": ("tab",),
            "fields": ("part_ids", "scheduled_at"),
        }),
        ("Technical", {
            "classes": ("tab",),
    ...
    def parts_display(self, obj):
        return f"{len(obj.part_ids)} part(s)"
